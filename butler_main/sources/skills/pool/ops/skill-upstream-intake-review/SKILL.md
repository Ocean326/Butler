...
- `./butler_main/sources/skills/pool/ops/skill-upstream-intake-review/scripts/intake_upstream_candidates.py`
...
& '.venv\Scripts\python.exe' `
  'butler_main/sources/skills/pool/ops/skill-upstream-intake-review/scripts/intake_upstream_candidates.py' `
  --workspace '.' `
  --candidates-file 'butler_main/sources/skills/agent/skill_manager_agent/references/external_skill_candidates_2026-03-24.json' `
  --dest-root 'butler_main/sources/skills/pool/incubating' `
  --output-dir 'butler_main/sources/skills/temp/upstream-review'
```
...
4. `butler_main/sources/skills/temp/upstream-review/skill_upstream_intake_report.md`
5. `butler_main/sources/skills/temp/upstream-review/skill_upstream_intake_report.json`
