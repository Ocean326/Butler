...
- original candidate path: ./butler_main/sources/skills/pool/incubating/forum/github-discussions-graphql

## 运行方式

```powershell
& '.venv\Scripts\python.exe' `
  'butler_main/sources/skills/pool/forum/github-discussions-read/scripts/run.py' `
