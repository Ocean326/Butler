...
- original candidate path: ./butler_main/sources/skills/pool/incubating/research/arxiv-py-paper-retrieval

## 运行方式

```powershell
& '.venv\Scripts\python.exe' `
  'butler_main/sources/skills/pool/research/arxiv-search/scripts/run.py' `
