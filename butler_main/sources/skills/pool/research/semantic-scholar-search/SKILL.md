...
- original candidate path: ./butler_main/sources/skills/pool/incubating/research/semantic-scholar-api

## 运行方式

```powershell
& '.venv\Scripts\python.exe' `
  'butler_main/sources/skills/pool/research/semantic-scholar-search/scripts/run.py' `
