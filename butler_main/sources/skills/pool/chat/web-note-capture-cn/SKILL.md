...
- 脚本路径：`./butler_main/sources/skills/pool/chat/web-note-capture-cn/scripts/social_capture.py`
- 推荐运行方式：

```powershell
& '.venv\Scripts\python.exe' `
  'butler_main/sources/skills/pool/chat/web-note-capture-cn/scripts/social_capture.py' `
