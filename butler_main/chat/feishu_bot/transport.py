...
def _candidate_config_paths(default_config_name: str) -> list[str]:
    ...
    return [
        os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "configs", config_name)),
        os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "butler_bot_code", "configs", config_name)),
    ]
...
def run_feishu_bot(
    ...
    if getattr(args, "interactive", False):
        ...
        if not CONFIG.get("workspace_root"):
            CONFIG["workspace_root"] = os.path.dirname(
