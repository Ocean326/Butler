...
from butler_main.repo_layout import INCUBATION_RESEARCH_REL, LEGACY_RESEARCH_REL, resolve_repo_path, resolve_repo_root
...
class FileResearchScenarioInstanceStore:
    def __init__(self, root_dir: str | Path | None = None, *, retention_days: int = DEFAULT_RETENTION_DAYS) -> None:
        ...
        default_root = resolve_repo_path(
            repo_root,
            canonical_rel=INCUBATION_RESEARCH_REL,
            compat_rel=LEGACY_RESEARCH_REL,
        ) / "run" / "scenario_instances"
