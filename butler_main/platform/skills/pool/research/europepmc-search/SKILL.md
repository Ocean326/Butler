...
- original candidate path: ./butler_main/platform/skills/pool/incubating/research/europepmc-rest-biomed

## 运行方式

```powershell
& '.venv\Scripts\python.exe' `
  'butler_main/platform/skills/pool/research/europepmc-search/scripts/run.py' `
