...
- original candidate path: ./butler_main/platform/skills/pool/incubating/research/openalex-pyalex

## 运行方式

```powershell
& '.venv\Scripts\python.exe' `
  'butler_main/platform/skills/pool/research/openalex-search/scripts/run.py' `
