...
- original candidate path: ./butler_main/platform/skills/pool/incubating/forum/discourse-api-monitor

## 运行方式

```powershell
& '.venv\Scripts\python.exe' `
  'butler_main/platform/skills/pool/forum/discourse-topic-read/scripts/run.py' `
