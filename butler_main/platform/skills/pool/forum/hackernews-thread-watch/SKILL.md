...
- original candidate path: ./butler_main/platform/skills/pool/incubating/forum/hackernews-api-ingest

## 运行方式

```powershell
& '.venv\Scripts\python.exe' `
  'butler_main/platform/skills/pool/forum/hackernews-thread-watch/scripts/run.py' `
