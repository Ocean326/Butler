...
def main() -> int:
    ...
    parser.add_argument(
        "--candidates-file",
        default="butler_main/platform/skills/agent/skill_manager_agent/references/external_skill_candidates_2026-03-24.json",
        help="Candidate JSON file",
    )
    parser.add_argument("--dest-root", default="butler_main/platform/skills/pool/incubating", help="Incubating skill root")
    parser.add_argument("--output-dir", default="", help="Output directory; defaults to butler_main/platform/skills/temp/upstream-review")
