...
ALLOWED_ROOTS = ("./butler_main/platform/skills/",)
...
def main() -> int:
    ...
    parser.add_argument("--output-dir", default="", help="Output directory; defaults to butler_main/platform/skills/temp/verify")
