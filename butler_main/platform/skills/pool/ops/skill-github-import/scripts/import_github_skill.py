...
def main() -> int:
    ...
    parser.add_argument("--dest-root", default="butler_main/platform/skills/pool/imported", help="Import root")
    ...
    report = [
        ...
        "2. 如需对 chat/codex 暴露，再更新 `butler_main/platform/skills/collections/registry.json`。",
