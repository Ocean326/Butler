...
- 脚本路径：`./butler_main/platform/skills/pool/chat/skill-library-explore/scripts/explore.py`
- 运行方式：

```powershell
& '.venv\Scripts\python.exe' `
  'butler_main/platform/skills/pool/chat/skill-library-explore/scripts/explore.py' `
  --query '图片OCR识别' `
  --output-dir 'butler_main/platform/skills/temp/explore'
```
...
| `--output-dir` | 否 | 输出目录，默认 `butler_main/platform/skills/temp/explore` |
