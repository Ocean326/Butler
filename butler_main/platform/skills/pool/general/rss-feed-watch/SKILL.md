...
- original candidate path: ./butler_main/platform/skills/pool/incubating/general/feedparser-rss-ingest

## 运行方式

```powershell
& '.venv\Scripts\python.exe' `
  'butler_main/platform/skills/pool/general/rss-feed-watch/scripts/run.py' `
