...
bots_dir = root / "butler_main" / "butler_bot_code" / "butler_bot"
butler_main_dir = root / "butler_main"
config_path = root / "butler_main" / "butler_bot_code" / "configs" / "butler_bot.json"
recent_path = root / "butler_main" / "chat" / "data" / "hot" / "recent_memory" / "recent_memory.json"

sys.path.insert(0, str(bots_dir))
sys.path.insert(0, str(butler_main_dir))
from butler_main.chat.feishu_bot import transport as ag

spec = importlib.util.spec_from_file_location("butler_chat_engine", butler_main_dir / "chat" / "engine.py")
