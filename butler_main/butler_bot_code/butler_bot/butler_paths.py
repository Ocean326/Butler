...
BOOTSTRAP_HOME_REL = Path("butler_main") / "butler_bot_agent" / "bootstrap"
SUBAGENT_HOME_REL = AGENT_HOME_REL / "sub-agents"
TEAM_HOME_REL = AGENT_HOME_REL / "teams"
PUBLIC_AGENT_LIBRARY_HOME_REL = AGENT_HOME_REL / "public-library"
PUBLIC_AGENT_LIBRARY_FILE_REL = PUBLIC_AGENT_LIBRARY_HOME_REL / "agent_public_library.json"
...
BUTLER_MAIN_AGENT_ROLE_FILE_REL = AGENT_HOME_REL / "butler-agent.md"
...
HEARTBEAT_EXECUTOR_WORKSPACE_HINT_FILE_REL = AGENT_HOME_REL / "heartbeat-executor-workspace-hint.md"
SUBCONSCIOUS_AGENT_ROLE_FILE_REL = AGENT_HOME_REL / "subconscious-agent.md"
FILE_MANAGER_AGENT_ROLE_FILE_REL = SUBAGENT_HOME_REL / "file-manager-agent.md"
HEARTBEAT_EXECUTOR_AGENT_ROLE_FILE_REL = SUBAGENT_HOME_REL / "heartbeat-executor-agent.md"
UPDATE_AGENT_ROLE_FILE_REL = SUBAGENT_HOME_REL / "update-agent.md"
...
SELF_MIND_DIR_REL = SPACE_HOME_REL / "self_mind"
...
HEARTBEAT_PROMPT_REL = AGENT_HOME_REL / "heartbeat-planner-prompt.md"
BOOTSTRAP_SOUL_FILE_REL = BOOTSTRAP_HOME_REL / "SOUL.md"
BOOTSTRAP_TALK_FILE_REL = BOOTSTRAP_HOME_REL / "TALK.md"
BOOTSTRAP_HEARTBEAT_FILE_REL = BOOTSTRAP_HOME_REL / "HEARTBEAT.md"
BOOTSTRAP_EXECUTOR_FILE_REL = BOOTSTRAP_HOME_REL / "EXECUTOR.md"
BOOTSTRAP_SELF_MIND_FILE_REL = BOOTSTRAP_HOME_REL / "SELF_MIND.md"
BOOTSTRAP_USER_FILE_REL = BOOTSTRAP_HOME_REL / "USER.md"
BOOTSTRAP_TOOLS_FILE_REL = BOOTSTRAP_HOME_REL / "TOOLS.md"
BOOTSTRAP_MEMORY_POLICY_FILE_REL = BOOTSTRAP_HOME_REL / "MEMORY_POLICY.md"
