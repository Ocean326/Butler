...
- `butler_main/products/butler_flow/desktop/` 是 Desktop 壳真落点
- `butler_main/products/butler_flow/desktop_bridge.py` 是 Python bridge 入口
- `butler_main/products/butler_flow/surface/` 是 TUI/Desktop 共用 shared surface
